...
test.describe.serial('UCC Search True - End to End API + UI Automation', () => {
  ...
  test('UCC Search - True API + UI validation', async () => {
    ...
    const runtimeData = {
      orderId: 'O-278466' // Replace with dynamic ID if needed
    };
    ...
    // UI Validation
    await uccSearchTrueWorkflow.UCCSearchUIValidation(orderId, groupId, uccSearchAPI, runtimeData, getCaseDetailsAPI);
  });
});
