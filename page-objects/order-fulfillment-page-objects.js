export class orderFulfillmentPageObjects {
    ...
    container_iframe_resultspage = '//div[@data-portalharnessinsname="Data-Portal!pyCaseWorker"]//main//div[@id="module2"]//div[@id="PegaWebGadget2"]';
    iframe_resultspage = '//iframe[@name="PegaGadget2Ifr"]'
    iframe_resultspage_identifier = 'PegaGadget2Ifr';
    container_iframe_anytimeActions = '//div[@data-portalharnessinsname="Data-Portal!pyCaseWorker"]//main//div[@id="module3"]//div[@id="PegaWebGadget3"]';
    iframe_anytimeActions = '//iframe[@name="PegaGadget3Ifr"';
    iframe_anytimeActions_identifier = "PegaGadget3Ifr";

    container_attachments = '//div[@name="BASE_REF" and contains(@base_ref, "pyWorkPage.pyAttachments")]';
    text_awaitingCustomerResponse = "(//table[@id='bodyTbl_gbl']//ul[@class='gridNode']//li//div[@id='CT' and contains(@class,'content-item') and @style=' ']//span[text()='Awaiting Customer Response' and @class='standard_wrap'])[1]";
